<x-admin-layout>
  ...
  <div class="flex">
	  ...
	  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat-left-text-fill" viewBox="0 0 16 16" transform="translate(10,1)">
  ...
  @foreach ($data as $key => $value)
	...
	<td class="py-3 px-6 text-center">
                                        ...
                                        <div class="w-6 mr-5 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 23 24" stroke="currentColor" transform="translate(126,1)">
